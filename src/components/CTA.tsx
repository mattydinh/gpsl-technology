    ...
    <section className="border-t border-zinc-200 bg-zinc-950 py-20">
      <div className="mx-auto max-w-2xl px-6 text-center">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <Link
            href={primaryHref}
            className="inline-flex items-center justify-center rounded-md border border-cyan-400/60 bg-cyan-400/10 px-5 py-2.5 font-mono text-sm font-medium text-cyan-400 transition-colors hover:bg-cyan-400/20 hover:border-cyan-400 hover:shadow-glow-sm"
          >
            {primaryLabel}
          </Link>

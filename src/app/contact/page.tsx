...
type TopicId = "execution" | "technology" | "general";

const TOPICS: { id: TopicId; label: string; body: string }[] = [
  {
    id: "execution",
    label: "Execution",
    body: "Operators, operating work, ventures, and the mission side of GPSL.",
  },
  {
    id: "technology",
    label: "Technology",
    body: "Product builds, AI engagements, and forward-deployed engineering.",
  },
  {
    id: "general",
    label: "General",
    body: "Partnerships, press, introductions, or anything that does not fit the other two.",
  },
];
...
const SUBJECTS: Record<TopicId, string> = {
  ...
  general: "GPSL — General inquiry",
};

const EMAIL = "matthew.dinh@gpsl-ubo.com";

function resolveTopic(raw: string | null): TopicId {
  if (raw === "execution" || raw === "technology" || raw === "general") {
    return raw;
  }
  // URL back-compat: /contact?topic=partnerships → general
  if (raw === "partnerships") {
    return "general";
  }
  return "execution";
...
function ContactInner() {
  ...
  const initialTopic: TopicId = resolveTopic(searchParams.get("topic"));
    ...
    <>
      ...
      <div className="max-w-6xl mx-auto px-6 pt-24 pb-12">
        ...
        <p className="text-lg text-op-muted mt-6 max-w-2xl leading-relaxed">
          Tell us what brings you in. We will come back with the right person
          ...
          {TOPICS.map((topic, i) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-display text-xl font-semibold text-op-ink mt-2 tracking-[-0.01em]">
                  {topic.label}
                </h3>
